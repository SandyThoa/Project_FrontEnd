...
$(document).ready(function(){
    ...
    $('#Scroll-down12').click(function () {
        $('body,html').animate({
            scrollTop:$('.contant3').offset().top
        }, 'slow');
    });

    $('#Scroll-down13').click(function () {
        $('body,html').animate({
            scrollTop:$('.contant4').offset().top
        }, 'slow');
    });

    $('#Scroll-down14').click(function () {
        $('body,html').animate({
            scrollTop:$('.contant5').offset().top
        }, 'slow');
    });
